...
#ifdef PARALLEL
        call stop_all('read_restart', 'Parallel restart temporarily disabled. &
                       &Please implement a robust HDF5-based solution.')
...
!                    if (i > iread+1 .and. .not.bit_str_gt(det,prev_det)) then
