            ...
            do icycle = 1, ncycles
                ...
                do idet = 1, tot_walkers ! loop over walkers/dets
                    ...
                    do iparticle = 1, abs(walker_population(1,idet))
                        ...
                        call spawner_ptr(cdet, walker_population(1,idet), gen_excit_ptr, nspawned, connection)
                    ...
                    do iparticle = 1, abs(walker_population(2,idet))
                        ...
                        call spawner_ptr(cdet, walker_population(2,idet), gen_excit_ptr, nspawned, connection)
                        ! Spawn if attempt was successful.
                        if (nspawned /= 0) call create_spawned_particle_ptr(cdet, connection, nspawned, spawned_hf_pop)
