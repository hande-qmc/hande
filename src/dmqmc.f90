    ...
    subroutine do_dmqmc(sys)
        ...
        do beta_cycle = 1, beta_loops
            ...
            do ireport = 1, nreport
                ...
                call end_report_loop(sys, ireport, iteration, .false., tot_nparticles_old, t1, semi_stoch_shift_iter, &
                                      semi_stoch_start_iter, soft_exit, .false., bloom_stats=bloom_stats)
