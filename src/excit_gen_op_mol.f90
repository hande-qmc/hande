...
! for operators of arbitrary symmetries.
    ...
    subroutine gen_excit_one_body_mol(cdet, pgen, connection, matel)
        ...
        call choose_ia_mol(op_sym, cdet%f, cdet%occ_list, cdet%symunocc, connection%from_orb(1), &
    ...
    subroutine gen_excit_one_body_mol_no_renorm(cdet, pgen, connection, matel)
        ...
        ! 1. Select orbital to excite from and orbital to excit into.
        call find_ia_mol(op_sym, cdet%f, cdet%occ_list, connection%from_orb(1), &
                         connection%to_orb(1), allowed_excitation)
        connection%nexcit = 1
