module hdf5_system
    ...
    contains
...
#ifndef DISABLE_HDF5
        subroutine init_system_hdf5(write_mode, sys, filename, kinds, verbose, in_name)
            ...
            if (write_mode) then
                if (in_name == '') then
                    ...
                    ! If provided filename overwrite autogenerated name.
                    filename = in_name
                end if
            else
        ...
        subroutine dump_system_hdf5(sys, filename)
            ...
            !   filename (optional): filename to dump hdf5 file to.
            ...
            call h5open_f(ierr)
            call init_system_hdf5(.true., sys, integral_filename, kinds, in_name = filename)
