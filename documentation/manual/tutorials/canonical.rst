...
energy - precise definitions of everything can be found in the output file.  The data can
be analysed to find the mean and standard error using the ``analyse_canonical.py`` script
in the ``tools/dmqmc`` subdirectory:

.. code-block:: bash

    $ analyse_canonical.py canonical_energy.out
