...
HANDE can currently perform Full Configuration Interaction (FCI) and
Full Configuration Interaction Quantum Monte Carlo calculations of various
systems, including those specified by and FCIDUMP [Knowles_Handy_89]_
which can be generated by MOLPRO, Q-Chem (with patches from AJWT) and PSI4
(with patches from JSS) as well as the Hubbard
